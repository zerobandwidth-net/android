...
import static net.zer0bandwidth.android.lib.database.SQLiteSyntax.SQL_INSERT_INTO;
...
extends QueryBuilder<InsertionBuilder,Long>
{
	 ...
	 *  {@link net.zer0bandwidth.android.lib.database.SQLiteSyntax#INSERT_FAILED}
